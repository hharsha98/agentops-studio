...
from .replay_store import advance_run, get_run
...
def create_worker_job(run_id: str) -> WorkerJob | None:
    run = get_run(run_id)
    if run is None:
        return None
...
def get_worker_job(job_id: str) -> WorkerJob | None:
    return JOBS.get(job_id)


def tick_worker_job(job_id: str) -> WorkerJob | None:
